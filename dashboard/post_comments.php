...
<h1 class="page-header">
     <center class="text-info">Comment Section</center>
...
echo "<td><a class='btn btn-danger' href='post_comments.php?del={$comment_id}&id=". $_GET['id'] ."' onClick=\"javascript: return confirm('Are you sure you want to Delete this Comment');\"> DELETE </a></td>";
}
?>
</tr>  </tbody></table> 
<?php 
